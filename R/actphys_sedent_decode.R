...
#'   \item{ NOIND }{  numeric }
#'   \item{ transport_personnel }{  character }
#'   \item{ transport_ecole }{  character }
...
#'   \item{ enfant_actif }{  character }
#'   \item{ eps_ouinon }{  character }
#'   \item{ eps_nbjours }{  numeric }
#'   \item{ eps_duree }{  character }
#'   \item{ club_nbjours }{  numeric }
#'   \item{ club_nb }{  character }
...
#'   \item{ nap }{  character }
#'   \item{ profil_activite }{  character }
#'   \item{ sedentarite }{  character }
