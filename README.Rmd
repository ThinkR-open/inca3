...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/Cervangirard/inca3.svg?branch=master)](https://travis-ci.org/Cervangirard/inca3)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/Cervangirard/inca3?branch=master&svg=true)](https://ci.appveyor.com/project/Cervangirard/inca3)
<!-- badges: end -->
