...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/ThinkR-open/inca3.svg?branch=master)](https://travis-ci.org/ThinkR-open/inca3)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/ThinkR-open/inca3?branch=master&svg=true)](https://ci.appveyor.com/project/ThinkR-open/inca3)
[![R build status](https://github.com/ThinkR-open/inca3/workflows/R-CMD-check/badge.svg)](https://github.com/ThinkR-open/inca3/actions)
<!-- badges: end -->

<!-- description: start -->
Le package {inca3} est un pakcage qui contient les jeux de données issu de l'étude [inca3](https://www.anses.fr/fr/content/etude-inca-3-pr%C3%A9sentation). 
